class CourseRegistrationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @course_registration.save
        format.html { redirect_to course_path(@course), notice: 'You have officially registered!  You can now access all course lessons and materials.' }
  ...
  private
    ...
    def course_registration_params
      params.require(:course_registration).permit(:user_id, :course_id)
    end
end
