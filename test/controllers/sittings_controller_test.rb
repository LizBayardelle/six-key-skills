...
class SittingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sitting" do
    assert_difference('Sitting.count') do
      post sittings_url, params: { sitting: { quiz_id: @sitting.quiz_id, results: @sitting.results, user_id: @sitting.user_id } }
    end
  ...
  test "should update sitting" do
    patch sitting_url(@sitting), params: { sitting: { quiz_id: @sitting.quiz_id, results: @sitting.results, user_id: @sitting.user_id } }
